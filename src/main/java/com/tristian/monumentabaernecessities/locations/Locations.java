package com.tristian.monumentabaernecessities.locations;
...
import com.tristian.monumentabaernecessities.mixin.PlayerListHudAccessor;
...
public class Locations {
    ...
    private static final Gson GSON = new GsonBuilder()
            .setPrettyPrinting()
            .create();
    private static final Identifier FILE_IDENTIFIER = new Identifier(MonumentaBaerNecessities.MOD_IDENTIFIER, "override/locations.json");

    public void reload() {
        try (InputStream stream = MinecraftClient.getInstance().getResourceManager().getResource(FILE_IDENTIFIER).orElseThrow().getInputStream();
